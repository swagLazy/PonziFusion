...
dotpath = "/mnt/3.6T-DATA/hcx/workspace/cfgbuilder/dots/"
txtpath = "/mnt/3.6T-DATA/hcx/workspace/cfgbuilder/txts/"


class Cfg:
    __slots__ = ['_name', '_basicBlocks', '_length', '_dispatchers', '_fallbacks', '_functions', '_loaders',
                 '_tooshort']
