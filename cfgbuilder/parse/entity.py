import re,logging
path = "C:/Users/Administrator/Desktop/黄琮雄-科研资资料/cfgbuilder/logs/"
class Logger:
    ...
    def addOrphanJumpTargetUnknownErrors(self,cn,source):
        self.contractlist.add(cn)
        self.logger.error("{} OrphanJumpTargetUnknownErrors at {:x},symbolic execution found an unknown value".format(cn,source))
